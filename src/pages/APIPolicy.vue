<template>
  <div class="policy">
    ...
    <section>
      ...
      <ol>
        <li>
          本規約は，授業インポート用のリンクを発行や共有をする者（サービス）と，授業インポート用のリンクを利用して授業をインポートする者，その他Twin:teの外部連携機能を利用する者（サービス）に適用されます。
        </li>
      </ol>
    </section>
    <section>
      ...
      <ol>
        <li>
          Twin:teの外部連携機能（授業を外部からインポートする機能を含む）は各個人が本規約と<a
            href="/policy"
            >利用規約</a
        ...
        <li>
          Twin:te運営は本規約に違反した者やサービスについて，Twin:teは外部連携機能（授業を外部からインポートする機能を含む）の利用の差し止めを行うことができるものとします。
        </li>
      </ol>
    </section>
